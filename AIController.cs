...
namespace SpaceShooter
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        private Timer m_RanomizeDirectionTimer;
            ...
            if (m_AIBehaviour == AIBehaviour.Patrol)
            {
                ...
                else
                {
                    if (m_PatrolPoint != null)
                    {
                        ...
                        {
                            // Keep moving towards patrol zone
        ...
        {
            // Random moving inside patrol zone
            if (m_RanomizeDirectionTimer.IsFinished == true)
            {
                Vector2 newPoint = UnityEngine.Random.onUnitSphere * m_PatrolPoint.Radius + m_PatrolPoint.transform.position;

                m_MovePosition = newPoint;

                m_RanomizeDirectionTimer.Start(m_RandomSelectMovePointTime);
            }
        }
        ...
        {
            m_RanomizeDirectionTimer = new Timer(m_RandomSelectMovePointTime);
        ...
        {
            m_RanomizeDirectionTimer.RemoveTime(Time.deltaTime);
